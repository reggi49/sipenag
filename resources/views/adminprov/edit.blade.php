...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1>Verifikasi Dokumen Usulan Formasi Pengawas Tingkat Provinsi</h1>
    ...
    <form action="{{ route('adminprov.update', $formasi->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <input type="text" name="status" id="status" class="form-control invisible" value=2>
            <button type="submit" class="btn btn-primary">Submit Ke Pusat</button>
        </form>
        </div>
    </div>
</div>
